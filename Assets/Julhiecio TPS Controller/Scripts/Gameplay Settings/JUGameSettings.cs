    ...
    public class JUGameSettings : MonoBehaviour
    {
        ...
        public static float RenderScale
        {
            ...
            set
            {
                ...
                int targetWidth = (int)(biggestResolution.width * value);
                int targetHeight = (int)(biggestResolution.height * value);

                #if UNITY_6000_0_OR_NEWER || UNITY_2023_1_OR_NEWER
                Screen.SetResolution(targetWidth, targetHeight, Screen.fullScreenMode, currentResolution.refreshRateRatio);
                #else
                Screen.SetResolution(targetWidth, targetHeight, Screen.fullScreen, currentResolution.refreshRate);
                #endif
