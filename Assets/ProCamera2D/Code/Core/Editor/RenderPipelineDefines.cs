...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    public static class RenderPipelineDefines
    {
        ...
        private static void DefinePreProcessors(bool defineHDRP, bool defineURP)
        {
            ...
            originalDefineSymbols = PC2DEditorCompat.GetScriptingDefineSymbolsForGroup(platform);
            ...
            {
                PC2DEditorCompat.SetScriptingDefineSymbolsForGroup(platform, newDefineSymbols);
            }
        }
    }
}
