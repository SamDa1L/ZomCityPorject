...
namespace JUTPS.UI
{
    ...
    public class Crosshair : MonoBehaviour
    {
        ...
        [SerializeField] private JUCameraController cameraController;
        ...
        private void ResolveCameraController()
        {
            ...
            if (Time.unscaledTime < _nextCameraSearchTime) return;
        ...
        protected virtual void UpdateObjectOnCrosshairPoint()
        {
            ...
            {
                cameraController.mCamera = cameraController.GetComponentInChildren<Camera>();
            }

            Camera raycastCamera = cameraController.mCamera != null ? cameraController.mCamera : Camera.main;
            ...
            GetObjectOnCrosshairPoint(raycastCamera, cameraController.CrosshairRaycastLayerMask, out ObjectOnCrosshairPoint);
        ...
        public static float GetWeaponPrecisionValue(float Current, Weapon WeaponInUse, float Speed = 8)
        {
            ...
            {
                #if UNITY_6000_0_OR_NEWER || UNITY_2023_1_OR_NEWER
                Instance = Object.FindAnyObjectByType<Crosshair>();
                #else
