...
namespace JUTPS.CharacterBrain
{
    ...
    public class JUCharacterBrain : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            MyPivotCamera = (IsArtificialIntelligence == false) ? Object.FindAnyObjectByType<JUCameraController>() : null;
            #else
        ...
        public virtual void RessurectCharacter()
        {
            ...
            //Reset Camera
            #if UNITY_6000_0_OR_NEWER || UNITY_2023_1_OR_NEWER
            var tpsCam = Object.FindAnyObjectByType<TPSCameraController>();
            #else
            var tpsCam = FindObjectOfType<TPSCameraController>();
            #endif
            if (tpsCam != null) { tpsCam.mCamera.transform.localEulerAngles = Vector3.zero; }
