...
namespace Com.LuisPedroFonseca.ProCamera2D
{
    ...
    public class ProCamera2DHierarchyIcon : MonoBehaviour
    {
        ...
        static Object InstanceIdToObjectCompat(int instanceID)
        {
            return PC2DEditorCompat.InstanceIdToObject(instanceID);
        }

        static void HierarchyItemCB(int instanceID, Rect selectionRect)
        {
            GameObject go = InstanceIdToObjectCompat(instanceID) as GameObject;
