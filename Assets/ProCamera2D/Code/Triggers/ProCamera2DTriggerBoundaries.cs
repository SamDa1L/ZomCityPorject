    ...
    public class ProCamera2DTriggerBoundaries : BaseTrigger, IPositionOverrider
    {
        ...
        public bool SetAsStartingBoundaries
        {
            set
            {
                ...
                {
                    var allBoundariesTriggers = PC2DUnityCompat.FindObjectsByType(typeof(ProCamera2DTriggerBoundaries));
        ...
        void Start()
        {
            ...
            {
                var numericBoundaries = PC2DUnityCompat.FindFirstObjectByType<ProCamera2DNumericBoundaries>();
