...
namespace Com.LuisPedroFonseca.ProCamera2D
{
        ...
        void OnEnable()
        {
            ...
            foreach (MonoScript m in scripts)
            {
                ...
                if (scriptClass != null && scriptClass.IsSubclassOf(typeof(BasePC2D)))
                {
                    ...
                    if (triggerName != null)
                    {
                        var allTriggers = PC2DUnityCompat.FindObjectsByType(scriptClass).ToList();
    ...
    // Centralized Unity-version compatibility layer for editor scripts.
    internal static class PC2DEditorCompat
    {
        public static UnityEngine.Object InstanceIdToObject(int instanceID)
        {
#if UNITY_6000_0_OR_NEWER
            var method = typeof(EditorUtility).GetMethod("EntityIdToObject", System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Static, null, new[] { typeof(int) }, null);
            if (method != null)
            {
...
#pragma warning restore CS0618
        ...
        public static void SetScriptingDefineSymbolsForGroup(BuildTargetGroup group, string defineSymbols)
        {
#if UNITY_2023_1_OR_NEWER || UNITY_6000_0_OR_NEWER
            var namedBuildTarget = UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(group);
